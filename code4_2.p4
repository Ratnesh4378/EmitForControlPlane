...
struct ingress_metadata_t {
    ...
    bit<32> filterKey_2_0;
    bit<32> filterKey_2_1;
    bit<32> filterKey_2_2;
    bit<32> filterKey_2_3;
    bit<32> filterKey_2_4;
    bit<32> filterKey_2_5;
    bit<32> filterKey_2_6;
    bit<32> filterKey_2_l32;
    bit<16> filterKey_2_l16;
    bit<8> filterKey_2_l8;
    bit<32> filterVal_2_0;
    bit<32> filterVal_2_1;
    bit<32> filterVal_2_2;
    bit<32> filterVal_2_3;
    bit<32> filterVal_2_4;
    bit<32> filterVal_2_5;
    bit<32> filterVal_2_6;
    bit<32> filterVal_2_l32;
    bit<16> filterVal_2_l16;
    bit<8> filterVal_2_l8;
    bit<32> filterKey_3_0;
    bit<32> filterKey_3_1;
    bit<32> filterKey_3_2;
    bit<32> filterKey_3_3;
    bit<32> filterKey_3_4;
    bit<32> filterKey_3_5;
    bit<32> filterKey_3_6;
    bit<32> filterKey_3_l32;
    bit<16> filterKey_3_l16;
    bit<8> filterKey_3_l8;
    bit<32> filterVal_3_0;
    bit<32> filterVal_3_1;
    bit<32> filterVal_3_2;
    bit<32> filterVal_3_3;
    bit<32> filterVal_3_4;
    bit<32> filterVal_3_5;
    bit<32> filterVal_3_6;
    bit<32> filterVal_3_l32;
    bit<16> filterVal_3_l16;
    bit<8> filterVal_3_l8;
